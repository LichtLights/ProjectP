...
#include "DBAbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FDBAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class PROJECTP_API UDBAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FDBAbilityTagRelationship> AbilityTagRelationships;
