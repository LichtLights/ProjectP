...
#include "DBGameplayCueManager.generated.h"

/**
 *	UDBGameplayCueManager
 *
 *	Game-specific manager for gameplay cues
 */
UCLASS()
class PROJECTP_API UDBGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:

	UDBGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UDBGameplayCueManager* Get();
