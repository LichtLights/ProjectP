...
inline FInteractionOption FInteractionOption::CreateInteractionOption(const EInteractionOptionType Type, TScriptInterface<IInteractableTarget> Target)
{
	...
	case EInteractionOptionType::Loot_Box:
		...
		// Option.InteractionGameplayTag = FGameplayTag::RequestGameplayTag(FName(TEXT("InputTag.Ability.Interact.LootBox")));
		//
	...
	case EInteractionOptionType::Unlock_Box:
		...
		// Option.InteractionGameplayTag = FGameplayTag::RequestGameplayTag(FName(TEXT("InputTag.Ability.Interact.UnlockBox")));
		//
	...
	case EInteractionOptionType::Open_Door:
		...
		Option.InteractionGameplayTag = FGameplayTag::RequestGameplayTag(FName(TEXT("InputTag.Ability.Interact.OpenDoor")));
	...
	case EInteractionOptionType::Close_Door:
		...
		Option.InteractionGameplayTag = FGameplayTag::RequestGameplayTag(FName(TEXT("InputTag.Ability.Interact.CloseDoor")));
	...
	case EInteractionOptionType::Unlock_Door:
		...
		Option.InteractionGameplayTag = FGameplayTag::RequestGameplayTag(FName(TEXT("InputTag.Ability.Interact.UnlockDoor")));
