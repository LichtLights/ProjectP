...
#include "DBSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class PROJECTP_API UDBSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()

public:

	UDBSettingValueDiscrete_Resolution();
