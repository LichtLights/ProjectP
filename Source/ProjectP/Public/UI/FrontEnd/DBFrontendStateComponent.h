...
#include "DBFrontendStateComponent.generated.h"
...
UCLASS(Abstract)
class PROJECTP_API UDBFrontendStateComponent : public UGameStateComponent, public ILoadingProcessInterface
{
	GENERATED_BODY()

public:

	UDBFrontendStateComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
private:
	void OnExperienceLoaded(const UDBExperienceDefinition* Experience);
