...
class PROJECTP_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UDBIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UDBIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UDBIndicatorManagerComponent> ManagerPtr;
