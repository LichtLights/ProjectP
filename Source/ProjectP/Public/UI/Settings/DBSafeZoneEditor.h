...
#include "DBSafeZoneEditor.generated.h"
 ...
 */
UCLASS(Abstract)
class UDBSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UDBSafeZoneEditor(const FObjectInitializer& Initializer);
