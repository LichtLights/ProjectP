...
#include "System/GameFeatures/GameFeatureAction_AddWidgets.h"
#include "CommonUIExtensions.h"
#include "GameFeaturesSubsystemSettings.h"
#include "Components/GameFrameworkComponentManager.h"
#include "Engine/GameInstance.h"
#include "System/GameFeatures/GameFeatureAction_WorldActionBase.h"
#include "UI/DBHUD.h"
...
#define LOCTEXT_NAMESPACE "DBGameFeatures"
...
{
	for (const FDBHUDElementEntry& Entry : Widgets)
	{
...
EDataValidationResult UGameFeatureAction_AddWidgets::IsDataValid(class FDataValidationContext& Context) const
{
	...
	{
		int32 EntryIndex = 0;
		for (const FDBHUDLayoutRequest& Entry : Layout)
		{
	...
	const FGameFeatureStateChangeContext& ChangeContext)
{
	...
	if ((GameInstance != nullptr) && (World != nullptr) && World->IsGameWorld())
	{
		...
		{			
			TSoftClassPtr<AActor> HUDActorClass = ADBHUD::StaticClass();
...
{
	ADBHUD* HUD = CastChecked<ADBHUD>(Actor);
