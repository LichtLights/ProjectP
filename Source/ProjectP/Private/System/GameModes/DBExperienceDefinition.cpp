...
#include UE_INLINE_GENERATED_CPP_BY_NAME(DBExperienceDefinition)

#define LOCTEXT_NAMESPACE "DBSystem"

UDBExperienceDefinition::UDBExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UDBExperienceDefinition::IsDataValid(class FDataValidationContext& Context) const
{
...
void UDBExperienceDefinition::UpdateAssetBundleData()
{
