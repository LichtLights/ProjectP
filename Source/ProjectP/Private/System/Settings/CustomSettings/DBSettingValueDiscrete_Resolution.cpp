...
#include "System/Settings/CustomSettings/DBSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(DBSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "DBSettings"

UDBSettingValueDiscrete_Resolution::UDBSettingValueDiscrete_Resolution()
{
}

void UDBSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UDBSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UDBSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UDBSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UDBSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UDBSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UDBSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UDBSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UDBSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
bool UDBSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes,
	int32 FilterThreshold) const
{
...
void UDBSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution,
	const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
void UDBSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
int32 UDBSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UDBSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UDBSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{
	int32 Index = 0;
...
FText UDBSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
