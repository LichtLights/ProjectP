...
#include "UI/Foundation/DBActionWidget.h"
...
FSlateBrush UDBActionWidget::GetIcon() const
{
...
UEnhancedInputLocalPlayerSubsystem* UDBActionWidget::GetEnhancedInputSubsystem() const
{
