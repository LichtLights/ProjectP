...
#include "UI/DBGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(DBGameViewportClient)
...
UDBGameViewportClient::UDBGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UDBGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance,
