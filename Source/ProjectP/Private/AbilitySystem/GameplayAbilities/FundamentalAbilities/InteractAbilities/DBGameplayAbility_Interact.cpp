...
UE_DEFINE_GAMEPLAY_TAG(TAG_Interaction_CycleTarget, "Ability.Interaction.CycleTarget");
UE_DEFINE_GAMEPLAY_TAG(TAG_Interaction_CycleOption, "Ability.Interaction.CycleOption");

UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Ability_Interaction_Activate, "Ability.Interaction.Activate");
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Ability_Interaction_Activate_Collect, "Ability.Interaction.Activate.Collect");
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Ability_Interaction_Activate_OpenDoor, "Ability.Interaction.Activate.OpenDoor");
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Ability_Interaction_Activate_CloseDoor, "Ability.Interaction.Activate.CloseDoor");
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Ability_Interaction_Activate_UnlockDoor, "Ability.Interaction.Activate.UnlockDoor");
	...
	const FGameplayEventData* TriggerEventData)
{
	...
	if (UAbilityTask_WaitGameplayEvent* CycleTargetTask = UAbilityTask_WaitGameplayEvent::WaitGameplayEvent(this, TAG_Interaction_CycleTarget))
	{
	...
	if (UAbilityTask_WaitGameplayEvent* CycleOptionTask = UAbilityTask_WaitGameplayEvent::WaitGameplayEvent(this, TAG_Interaction_CycleOption))
	{
...
void UDBGameplayAbility_Interact::TriggerInteraction()
{
	...
	switch (ActiveOption.InteractionOptionType)
	{
	...
	case EInteractionOptionType::Collect:
		...
		EventTag = TAG_Ability_Interaction_Activate_Collect;
		
		break;
		
	case EInteractionOptionType::Open_Door:
			
		EventTag = TAG_Ability_Interaction_Activate_OpenDoor;
		
		break;
		
	case EInteractionOptionType::Close_Door:

		EventTag = TAG_Ability_Interaction_Activate_CloseDoor;
		
		break;

	case EInteractionOptionType::Unlock_Door:

		EventTag = TAG_Ability_Interaction_Activate_UnlockDoor;
